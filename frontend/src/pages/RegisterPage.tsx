  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-kasa-light px-4 dark:bg-slate-950">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -right-32 top-1/4 h-80 w-80 rounded-full bg-kasa-accent/[0.05] blur-3xl" />
        <div className="absolute -left-32 bottom-1/3 h-96 w-96 rounded-full bg-kasa-primary/[0.04] blur-3xl" />
      </div>
